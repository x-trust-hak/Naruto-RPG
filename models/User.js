...
const UserSchema = new mongoose.Schema({
    ...
    rankPoints:       { type: Number, default: 0 },   // PvP arena rating (lifetime)

    // Arena Season
    seasonSp:         { type: Number, default: 0 },   // season points (resets each month)
    seasonWins:       { type: Number, default: 0 },   // wins this season
    seasonLosses:     { type: Number, default: 0 },   // losses this season
    seasonTitles:     { type: [String], default: [] },// past season titles
    ...
    giftDailyData: {
        ...
        ryoGiven:  { type: Number, default: 0 },
    },
    ...
    // Village War
    warKills:         { type: Number, default: 0 },   // enemy village kills in wars
    warVpContributed: { type: Number, default: 0 },   // total VP contributed to village
