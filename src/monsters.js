...
const MONSTERS = {
    d: [
        {
            ...
            moves: [
                { name: 'Rusty Slash', damage: 50, nature: null },
                { name: 'Dirty Throw', damage: 70, nature: null },
            ],
        ...
        },
        {
            ...
            moves: [
                { name: 'Charge', damage: 60, nature: null },
                { name: 'Tusk Gore', damage: 80, nature: null },
            ],
    ...
    c: [
        {
            ...
            moves: [
                { name: 'Kunai Barrage', damage: 90, nature: null },
                { name: 'Smoke Ambush', damage: 120, nature: null },
            ],
        ...
        },
        {
            ...
            moves: [
                { name: 'Chain Shred', damage: 100, nature: null },
                { name: 'Poison Gauntlet', damage: 130, nature: null },
            ],
    ...
    b: [
        {
            id: 'zabuza_npc', name: 'Demon of the Mist', emoji: '🌫️', image: 'welcome', nature: 'water',
            stats: { hp: 1000, attack: 100, defense: 70, speed: 80, crit: 15 },
            moves: [
                { name: 'Water Dragon', damage: 150, nature: 'water' },
                { name: 'Silent Killing', damage: 200, nature: null },
                { name: 'Hidden Mist', damage: 110, nature: 'water' },
            ],
        ...
        },
        {
            ...
            moves: [
                { name: 'Sound Wave', damage: 140, nature: null },
                { name: 'Curse Mark Strike', damage: 210, nature: null },
            ],
    ...
    a: [
        {
            ...
            moves: [
                { name: 'Striking Shadow Snakes', damage: 200, nature: null },
                { name: 'Kusanagi Blade', damage: 280, nature: null },
                { name: 'Immortality Regen', damage: -150, nature: null },
            ],
        ...
        },
        {
            ...
            moves: [
                { name: 'Chakra Scalpel', damage: 210, nature: null },
                { name: 'Sage Regen', damage: -180, nature: null },
                { name: 'Dead Soul Jutsu', damage: 250, nature: null },
            ],
    ...
    s: [
        {
            ...
            moves: [
                { name: 'Almighty Push', damage: 320, nature: null },
                { name: 'Universal Pull', damage: 260, nature: null },
                { name: 'Planetary Devastation', damage: 420, nature: 'earth' },
            ],
        ...
        },
        {
            ...
            moves: [
                { name: 'Perfect Susanoo', damage: 380, nature: null },
                { name: 'Meteor Drop', damage: 450, nature: 'fire' },
                { name: 'Limbo Clone', damage: 300, nature: null },
            ],
