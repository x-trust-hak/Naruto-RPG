...
const MONSTERS = {
    d: [
        {
            id: 'bandit', name: 'Rogue Bandit', emoji: '🗡️', image: 'welcome', nature: null,
            stats: { hp: 350, attack: 45, defense: 25, speed: 40, crit: 5 },
            moves: [
                { name: 'Rusty Slash', damage: 50, pp: 5, nature: null },
                { name: 'Dirty Throw', damage: 70, pp: 5, nature: null },
            ],
            reward: { minRyo: 200, maxRyo: 400, xp: 40, gemChance: 0 }
        },
        {
            id: 'wild_boar', name: 'Giant Boar', emoji: '🐗', image: 'welcome', nature: null,
            stats: { hp: 420, attack: 40, defense: 35, speed: 30, crit: 3 },
            moves: [
                { name: 'Charge', damage: 60, pp: 5, nature: null },
                { name: 'Tusk Gore', damage: 80, pp: 5, nature: null },
            ],
    ...
    c: [
        {
            id: 'missing_nin', name: 'Missing-Nin', emoji: '🥷', image: 'welcome', nature: null,
            stats: { hp: 650, attack: 70, defense: 45, speed: 65, crit: 12 },
            moves: [
                { name: 'Kunai Barrage', damage: 90, pp: 5, nature: null },
                { name: 'Smoke Ambush', damage: 120, pp: 4, nature: null },
            ],
            reward: { minRyo: 600, maxRyo: 1000, xp: 90, gemChance: 0 }
        },
        {
            id: 'demon_brothers', name: 'Demon Brothers', emoji: '⛓️', image: 'welcome', nature: null,
            stats: { hp: 700, attack: 75, defense: 50, speed: 60, crit: 10 },
            moves: [
                { name: 'Chain Shred', damage: 100, pp: 4, nature: null },
                { name: 'Poison Gauntlet', damage: 130, pp: 4, nature: null },
            ],
    ...
    b: [
        {
            id: 'zabuza_npc', name: 'Demon of the Mist', emoji: '🌫️', image: 'zabuza_water', nature: 'water',
            stats: { hp: 1000, attack: 100, defense: 70, speed: 80, crit: 15 },
            moves: [
                { name: 'Water Dragon', damage: 150, pp: 4, nature: 'water' },
                { name: 'Silent Killing', damage: 200, pp: 3, nature: null },
                { name: 'Hidden Mist', damage: 110, pp: 4, nature: 'water' },
            ],
            reward: { minRyo: 1500, maxRyo: 2800, xp: 180, gemChance: 0.1 }
        },
        {
            id: 'sound_four', name: 'Sound Elite', emoji: '🎵', image: 'welcome', nature: null,
            stats: { hp: 1100, attack: 95, defense: 80, speed: 75, crit: 14 },
            moves: [
                { name: 'Sound Wave', damage: 140, pp: 4, nature: null },
                { name: 'Curse Mark Strike', damage: 210, pp: 3, nature: null },
            ],
    ...
    a: [
        {
            id: 'orochimaru_npc', name: 'Orochimaru', emoji: '🐍', image: 'akatsuki', nature: null,
            stats: { hp: 1600, attack: 130, defense: 100, speed: 110, crit: 20 },
            moves: [
                { name: 'Striking Shadow Snakes', damage: 200, pp: 3, nature: null },
                { name: 'Kusanagi Blade', damage: 280, pp: 3, nature: null },
                { name: 'Immortality Regen', damage: -150, pp: 4, nature: null },
            ],
            reward: { minRyo: 3500, maxRyo: 6000, xp: 320, gemChance: 0.25 }
        },
        {
            id: 'kabuto_npc', name: 'Kabuto Yakushi', emoji: '🩺', image: 'akatsuki', nature: null,
            stats: { hp: 1500, attack: 120, defense: 110, speed: 100, crit: 18 },
            moves: [
                { name: 'Chakra Scalpel', damage: 210, pp: 3, nature: null },
                { name: 'Sage Regen', damage: -180, pp: 4, nature: null },
                { name: 'Dead Soul Jutsu', damage: 250, pp: 3, nature: null },
            ],
    ...
    s: [
        {
            id: 'pain_npc', name: 'Pain (Six Paths)', emoji: '🌧️', image: 'akatsuki', nature: null,
            stats: { hp: 2400, attack: 170, defense: 140, speed: 130, crit: 25 },
            moves: [
                { name: 'Almighty Push', damage: 320, pp: 2, nature: null },
                { name: 'Universal Pull', damage: 260, pp: 3, nature: null },
                { name: 'Planetary Devastation', damage: 420, pp: 2, nature: 'earth' },
            ],
            reward: { minRyo: 6000, maxRyo: 10000, xp: 500, gemChance: 0.5 }
        },
        {
            id: 'madara_npc', name: 'Madara Uchiha', emoji: '🌑', image: 'akatsuki', nature: 'fire',
            stats: { hp: 2800, attack: 190, defense: 150, speed: 140, crit: 30 },
            moves: [
                { name: 'Perfect Susanoo', damage: 380, pp: 2, nature: null },
                { name: 'Meteor Drop', damage: 450, pp: 2, nature: 'fire' },
                { name: 'Limbo Clone', damage: 300, pp: 2, nature: null },
            ],
